...
"""GPT-OSS Dynamo subfunction QAIC token parity tests."""
...
def test_gpt_oss_prefill_chunked_expert_parallel_subfunction_dynamo_hf_qaic_token_parity(tmp_export_dir, monkeypatch):
...
@pytest.mark.on_qaic
@pytest.mark.llm_model
def test_gpt_oss_decode_retain_full_kv_subfunction_dynamo_hf_qaic_token_parity(tmp_export_dir):
    model_hf, tokenizer = _load_gpt_oss_hf_and_tokenizer()
