...
def ctx_scatter(data: torch.Tensor, position_ids: torch.Tensor, updates: torch.Tensor) -> torch.Tensor:
    from QEfficient.customop.ctx_scatter_gather_opset17 import CtxScatterFunc
...
def ctx_scatter_3d(data: torch.Tensor, position_ids: torch.Tensor, updates: torch.Tensor) -> torch.Tensor:
    from QEfficient.customop.ctx_scatter_gather_opset17 import CtxScatterFunc3D
...
def ctx_scatter_3d_generalized(data: torch.Tensor, position_ids: torch.Tensor, updates: torch.Tensor) -> torch.Tensor:
    from QEfficient.customop.ctx_scatter_gather_opset17 import CtxScatterFunc3DGeneralized
...
def ctx_scatter_3d_int(data: torch.Tensor, position_ids: torch.Tensor, updates: torch.Tensor) -> torch.Tensor:
    from QEfficient.customop.ctx_scatter_gather_opset17 import CtxScatterFunc3DInt
...
def ctx_gather_3d(data: torch.Tensor, ctx_indices: torch.Tensor) -> torch.Tensor:
    from QEfficient.customop.ctx_scatter_gather_opset17 import CtxGatherFunc3D
...
def ctx_gather_3d_generalized(data: torch.Tensor, ctx_indices: torch.Tensor) -> torch.Tensor:
    from QEfficient.customop.ctx_scatter_gather_opset17 import CtxGatherFunc3DGeneralized
...
def ctx_gather(data: torch.Tensor, ctx_indices: torch.Tensor, comp_ctx_len: int) -> torch.Tensor:
    from QEfficient.customop.ctx_scatter_gather_opset17 import CtxGatherFunc
...
def ctx_gather_blocked_kv(data: torch.Tensor, ctx_indices: torch.Tensor) -> torch.Tensor:
    from QEfficient.customop.ctx_scatter_gather_opset17 import CtxGatherFuncBlockedKV
...
def ctx_scatter_cb(
    ...
    from QEfficient.customop.ctx_scatter_gather_cb_opset17 import CtxScatterFuncCB
...
def ctx_scatter_cb_3d(
    ...
    from QEfficient.customop.ctx_scatter_gather_cb_opset17 import CtxScatterFuncCB3D
...
def ctx_gather_cb(
    ...
    from QEfficient.customop.ctx_scatter_gather_cb_opset17 import CtxGatherFuncCB
...
def ctx_gather_blocked_kv_cb(data: torch.Tensor, batch_index: torch.Tensor, ctx_indices: torch.Tensor) -> torch.Tensor:
    from QEfficient.customop.ctx_scatter_gather_cb_opset17 import CtxGatherFuncBlockedKVCB
...
def ctx_gather_cb_3d(data: torch.Tensor, batch_index: torch.Tensor, ctx_indices: torch.Tensor) -> torch.Tensor:
    from QEfficient.customop.ctx_scatter_gather_cb_opset17 import CtxGatherFuncCB3D
