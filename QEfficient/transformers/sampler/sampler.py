...
def prefill_path(
    ...
    ctx_scatter_cb_3d_interface = select_interface(CtxScatterFuncCB3D.apply, torch.ops.qefficient.ctx_scatter_cb_3d)
    mul_value = ctx_scatter_cb_3d_interface(mul_value, batch_index, zero_tensor, positions_mask)
    ...
    past_repetition_penalty_buffer = ctx_scatter_cb_3d_interface(
...
def decode_path(
    ...
    past_presence_penalty_buffer = ctx_scatter_cb_3d_interface(
