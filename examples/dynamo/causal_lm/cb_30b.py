...
def run(
    ...
    if not skip_vision:
        ...
        print(f">>>>>>>>>>>>>>>>>>>>> vision_compile_kwargs: {vision_compile_kwargs}")
    ...
    print(f">>>>>>>>>>>>>>>>>>>>> prefill_compile_kwargs: {prefill_compile_kwargs}")
